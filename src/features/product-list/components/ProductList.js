...
import { selectAllProduct, fetchAllProductsAsync, fetchProductsByFiltersAsync } from "../ProductListSlice";
                    ...
                    <div className=" grid grid-cols-1 gap-x-4 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-4">
                      {products.map((product) => (
                        <Link to="/product-detail">
                          <div
                            key={product.id}
                            className="group border border-gray-200 relative transition-all p-2 hover:scale-105 hover:shadow-md hover:shadow-sky-200 rounded-lg"
                          >
                            <img
                              alt={product.imageAlt}
                              src={product.thumbnail}
                              className="aspect-square w-full rounded-md bg-gray-200 drop-shadow object-cover group-hover:opacity-75 group-hover:bg-blue-200 lg:aspect-auto lg:h-60"
                            />
