              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                <div className="lg:col-span-3 border-t border-gray-200">
                  <div>
                    ...
                    >
                      <button className="px-6 py-2 ml-8 font-semibold rounded text-sm text-white bg-green-500 hover:bg-green-400 transition-all">
                        Add New Product
                      </button>
                    </Link>
                  </div>
          ...
          {products.map((product, index) => (
            <div>
              <Link to={`/admin/product-detail/${product.id}`}>
                <div
                  key={index}
                  className="group border border-gray-300 relative transition-all p-2  hover:shadow-md hover:shadow-sky-200 rounded-lg"
                >
                  <img
                  ...
                  {product.deleted && <div className="text-red-500 text-sm">
                    product deleted
                    </div>}
                </div>
              </Link>
              <Link to={`/admin/product-form/edit/${product.id}`}>
                <button className="px-4 py-2 my-2 font-semibold rounded text-sm border border-indigo-300  bg-white text-indigo-500 hover:bg-indigo-100 transition-all">
                  Edit Product
                </button>
              </Link>
            </div>
                ...
                <div
                  ...
                  className={`relative z-10 inline-flex items-center border border-gray-300 ${
                    index + 1 === page
                      ...
                      : "bg-white text-gray-600 focus-visible:outline-indigo-600"
